...
func TestChaosKindMapShouldContainsCertificateChaos(t *testing.T) {
	g := NewGomegaWithT(t)
	var requiredType TemplateType
	requiredType = TypeCertificateChaos
...
func TestChaosKindMapShouldContainsCloudStackHostChaos(t *testing.T) {
	g := NewGomegaWithT(t)
	var requiredType TemplateType
	requiredType = TypeCloudStackHostChaos
...
func TestChaosKindMapShouldContainsNodeSelectorChaos(t *testing.T) {
	g := NewGomegaWithT(t)
	var requiredType TemplateType
	requiredType = TypeNodeSelectorChaos
