...
func (in *DeploymentChaos) ValidateCreate() error {
	DeploymentChaosWebhookLog.Info("validate create", "name", in.Name)
	return in.Validate()
}

// ValidateUpdate implements webhook.Validator so a webhook will be registered for the type
func (in *DeploymentChaos) ValidateUpdate(old runtime.Object) error {
...
// ValidateDelete implements webhook.Validator so a webhook will be registered for the type
func (in *DeploymentChaos) ValidateDelete() error {
...
func (in *DeploymentChaos) Validate() error {
	errs := gw.Validate(in)
	return gw.Aggregate(errs)
}
...
func (in *RollingRestartChaos) ValidateCreate() error {
	RollingRestartChaosWebhookLog.Info("validate create", "name", in.Name)
	return in.Validate()
}

// ValidateUpdate implements webhook.Validator so a webhook will be registered for the type
func (in *RollingRestartChaos) ValidateUpdate(old runtime.Object) error {
...
// ValidateDelete implements webhook.Validator so a webhook will be registered for the type
func (in *RollingRestartChaos) ValidateDelete() error {
...
func (in *RollingRestartChaos) Validate() error {
	errs := gw.Validate(in)
	return gw.Aggregate(errs)
}
