...
func (in *NodeChaos) ValidateCreate() (admission.Warnings, error) {
	NodeChaosWebhookLog.Info("validate create", "name", in.Name)
	return in.Validate()
}

// ValidateUpdate implements webhook.Validator so a webhook will be registered for the type
func (in *NodeChaos) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
...
// ValidateDelete implements webhook.Validator so a webhook will be registered for the type
func (in *NodeChaos) ValidateDelete() (admission.Warnings, error) {
...
func (in *NodeChaos) Validate() ([]string, error) {
	errs := gw.Validate(in)
	return nil, gw.Aggregate(errs)
}
...
const KindNodeNetworkChaos = "NodeNetworkChaos"

var NodeNetworkChaosWebhookLog = logf.Log.WithName("NodeNetworkChaos-resource")

func (in *NodeNetworkChaos) ValidateCreate() (admission.Warnings, error) {
	NodeNetworkChaosWebhookLog.Info("validate create", "name", in.Name)
	return in.Validate()
}

// ValidateUpdate implements webhook.Validator so a webhook will be registered for the type
func (in *NodeNetworkChaos) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
	NodeNetworkChaosWebhookLog.Info("validate update", "name", in.Name)
	return in.Validate()
}

// ValidateDelete implements webhook.Validator so a webhook will be registered for the type
func (in *NodeNetworkChaos) ValidateDelete() (admission.Warnings, error) {
	NodeNetworkChaosWebhookLog.Info("validate delete", "name", in.Name)

	// Nothing to do?
	return nil, nil
}

var _ webhook.Validator = &NodeNetworkChaos{}

func (in *NodeNetworkChaos) Validate() ([]string, error) {
	errs := gw.Validate(in)
	return nil, gw.Aggregate(errs)
}

var _ webhook.Defaulter = &NodeNetworkChaos{}

func (in *NodeNetworkChaos) Default() {
	gw.Default(in)
}
...
func init() {
	...
	SchemeBuilder.Register(&NodeNetworkChaos{}, &NodeNetworkChaosList{})
