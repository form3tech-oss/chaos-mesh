...
func (in *GCPAzChaos) ValidateCreate() (admission.Warnings, error) {
	GCPAzChaosWebhookLog.Info("validate create", "name", in.Name)
	return in.Validate()
}

// ValidateUpdate implements webhook.Validator so a webhook will be registered for the type
func (in *GCPAzChaos) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
...
// ValidateDelete implements webhook.Validator so a webhook will be registered for the type
func (in *GCPAzChaos) ValidateDelete() (admission.Warnings, error) {
...
func (in *GCPAzChaos) Validate() ([]string, error) {
	errs := gw.Validate(in)
	return nil, gw.Aggregate(errs)
}
...
func (in *GKENodePoolChaos) ValidateCreate() (admission.Warnings, error) {
	GKENodePoolChaosWebhookLog.Info("validate create", "name", in.Name)
	return in.Validate()
}

// ValidateUpdate implements webhook.Validator so a webhook will be registered for the type
func (in *GKENodePoolChaos) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
...
// ValidateDelete implements webhook.Validator so a webhook will be registered for the type
func (in *GKENodePoolChaos) ValidateDelete() (admission.Warnings, error) {
...
func (in *GKENodePoolChaos) Validate() ([]string, error) {
	errs := gw.Validate(in)
	return nil, gw.Aggregate(errs)
}
